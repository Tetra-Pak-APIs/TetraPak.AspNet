...
namespace TetraPak.AspNet
{
    ...
    public class HttpQueryParameters : IDictionary<string, string?>, IStringValue
    {
        /// <summary>
        ...
        ///   a <see cref="HttpQueryParameters"/> object. 
        /// </summary>
        public static implicit operator HttpQueryParameters(string s) => new(s);

        /// <summary>
        ///   Implicitly converts a <see cref="HttpQueryParameters"/> object
        ///   into its <see cref="string"/> representation.
        /// </summary>
        public static implicit operator string?(HttpQueryParameters? queryParameters) => queryParameters?.StringValue; 
        ...
        /// <summary>
        ///   Initializes the <see cref="HttpQueryParameters"/> from a textual representation.
        /// </summary>
    ...
    /// <summary>
    ///   Provides convenient methods for dealing with <see cref="HttpQueryParameters"/>.
    /// </summary>
    public static class HttpQueryParametersHelper
    {
        /// <summary>
        ///   Safely examines a (nullable) <see cref="HttpQueryParameters"/> object and returns
        ///   a value to indicate is is empty (or unassigned/<c>null</c>). 
        /// </summary>
        public static bool IsEmpty(this HttpQueryParameters? queryParameters) 
