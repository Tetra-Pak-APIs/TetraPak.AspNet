...
### Constructors
<a name='TetraPak_AspNet_TetraPakAuthConfig_TetraPakAuthConfig(Microsoft_Extensions_Configuration_IConfiguration_Microsoft_Extensions_Logging_ILogger_TetraPak_AspNet_TetraPakAuthConfig__TetraPak_AspNet_ITetraPakAuthConfigDelegate_)'></a>
## TetraPakAuthConfig.TetraPakAuthConfig(IConfiguration, ILogger&lt;TetraPakAuthConfig&gt;, ITetraPakAuthConfigDelegate?) Constructor
Initializes a Tetra Pak authorization configuration instance.   
```csharp
public TetraPakAuthConfig(Microsoft.Extensions.Configuration.IConfiguration configuration, Microsoft.Extensions.Logging.ILogger<TetraPak.AspNet.TetraPakAuthConfig> logger, TetraPak.AspNet.ITetraPakAuthConfigDelegate? configDelegate=null);
```
#### Parameters
<a name='TetraPak_AspNet_TetraPakAuthConfig_TetraPakAuthConfig(Microsoft_Extensions_Configuration_IConfiguration_Microsoft_Extensions_Logging_ILogger_TetraPak_AspNet_TetraPakAuthConfig__TetraPak_AspNet_ITetraPakAuthConfigDelegate_)_configuration'></a>
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_TetraPakAuthConfig(Microsoft_Extensions_Configuration_IConfiguration_Microsoft_Extensions_Logging_ILogger_TetraPak_AspNet_TetraPakAuthConfig__TetraPak_AspNet_ITetraPakAuthConfigDelegate_)_logger'></a>
`logger` [Microsoft.Extensions.Logging.ILogger&lt;](https://docs.microsoft.com/en-us/dotnet/api/Microsoft.Extensions.Logging.ILogger-1 'Microsoft.Extensions.Logging.ILogger`1')[TetraPakAuthConfig](TetraPak_AspNet_TetraPakAuthConfig.md 'TetraPak.AspNet.TetraPakAuthConfig')[&gt;](https://docs.microsoft.com/en-us/dotnet/api/Microsoft.Extensions.Logging.ILogger-1 'Microsoft.Extensions.Logging.ILogger`1')  
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_TetraPakAuthConfig(Microsoft_Extensions_Configuration_IConfiguration_Microsoft_Extensions_Logging_ILogger_TetraPak_AspNet_TetraPakAuthConfig__TetraPak_AspNet_ITetraPakAuthConfigDelegate_)_configDelegate'></a>
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_System_Nullable_System_Threading_CancellationToken_)'></a>
## TetraPakAuthConfig.GetScopeAsync(AuthContext, Nullable&lt;CancellationToken&gt;) Method
...
```
#### Parameters
<a name='TetraPak_AspNet_TetraPakAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_System_Nullable_System_Threading_CancellationToken_)_authContext'></a>
`authContext` [AuthContext](TetraPak_AspNet_AuthContext.md 'TetraPak.AspNet.AuthContext')  
Details the auth context in which the (confidential) client secrets are requested.  
  
<a name='TetraPak_AspNet_TetraPakAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_System_Nullable_System_Threading_CancellationToken_)_cancellationToken'></a>
`cancellationToken` [System.Nullable&lt;](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1 'System.Nullable`1')[System.Threading.CancellationToken](https://docs.microsoft.com/en-us/dotnet/api/System.Threading.CancellationToken 'System.Threading.CancellationToken')[&gt;](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1 'System.Nullable`1')  
(optional)<br />  
Cancellation token for cancellation the operation.  
...
Implements [GetScopeAsync(AuthContext, Nullable<CancellationToken>)](TetraPak_AspNet_Auth_IServiceAuthConfig.md#TetraPak_AspNet_Auth_IServiceAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_System_Nullable_System_Threading_CancellationToken_) 'TetraPak.AspNet.Auth.IServiceAuthConfig.GetScopeAsync(TetraPak.AspNet.AuthContext, System.Nullable&lt;System.Threading.CancellationToken&gt;)')  
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetClientIdAsync(TetraPak_AspNet_AuthContext)'></a>
## TetraPakAuthConfig.OnGetClientIdAsync(AuthContext) Method
Gets a client id.  
```csharp
protected virtual System.Threading.Tasks.Task<TetraPak.Outcome<string>> OnGetClientIdAsync(TetraPak.AspNet.AuthContext authContext);
```
#### Parameters
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetClientIdAsync(TetraPak_AspNet_AuthContext)_authContext'></a>
`authContext` [AuthContext](TetraPak_AspNet_AuthContext.md 'TetraPak.AspNet.AuthContext')  
Details the auth context in which the (confidential) client secrets are requested.  
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetClientSecretAsync(TetraPak_AspNet_AuthContext)'></a>
## TetraPakAuthConfig.OnGetClientSecretAsync(AuthContext) Method
Gets a client secret.  
```csharp
protected virtual System.Threading.Tasks.Task<TetraPak.Outcome<string>> OnGetClientSecretAsync(TetraPak.AspNet.AuthContext authContext);
```
#### Parameters
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetClientSecretAsync(TetraPak_AspNet_AuthContext)_authContext'></a>
`authContext` [AuthContext](TetraPak_AspNet_AuthContext.md 'TetraPak.AspNet.AuthContext')  
Details the auth context in which the (confidential) client secrets are requested.  
...
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetScopeAsync(TetraPak_AspNet_AuthContext)'></a>
## TetraPakAuthConfig.OnGetScopeAsync(AuthContext) Method
Gets a auth scope.  
```csharp
...
```
#### Parameters
<a name='TetraPak_AspNet_TetraPakAuthConfig_OnGetScopeAsync(TetraPak_AspNet_AuthContext)_authContext'></a>
`authContext` [AuthContext](TetraPak_AspNet_AuthContext.md 'TetraPak.AspNet.AuthContext')  
Details the auth context in which the (confidential) client secrets are requested.  
