...
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetConfiguredValue(string_string__)'></a>
## ServiceAuthConfig.GetConfiguredValue(string, string[]) Method
...
```
#### Parameters
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetConfiguredValue(string_string__)_key'></a>
`key` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')  
Identifies the requested value.  
  
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetConfiguredValue(string_string__)_fallbackKeys'></a>
...
(optional)<br/>  
Zero or more keys to be tested if [key](TetraPak_AspNet_Api_ServiceAuthConfig.md#TetraPak_AspNet_Api_ServiceAuthConfig_GetConfiguredValue(string_string__)_key 'TetraPak.AspNet.Api.ServiceAuthConfig.GetConfiguredValue(string, string[]).key') does not yield a result.   
...
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_TetraPak_MultiStringValue__System_Nullable_System_Threading_CancellationToken_)'></a>
## ServiceAuthConfig.GetScopeAsync(AuthContext, MultiStringValue?, Nullable&lt;CancellationToken&gt;) Method
...
```
#### Parameters
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_TetraPak_MultiStringValue__System_Nullable_System_Threading_CancellationToken_)_authContext'></a>
`authContext` [TetraPak.AspNet.AuthContext](https://docs.microsoft.com/en-us/dotnet/api/TetraPak.AspNet.AuthContext 'TetraPak.AspNet.AuthContext')  
Details the auth context in which the (confidential) client secrets are requested.  
  
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_TetraPak_MultiStringValue__System_Nullable_System_Threading_CancellationToken_)_useDefault'></a>
...
<a name='TetraPak_AspNet_Api_ServiceAuthConfig_GetScopeAsync(TetraPak_AspNet_AuthContext_TetraPak_MultiStringValue__System_Nullable_System_Threading_CancellationToken_)_cancellationToken'></a>
`cancellationToken` [System.Nullable&lt;](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1 'System.Nullable`1')[System.Threading.CancellationToken](https://docs.microsoft.com/en-us/dotnet/api/System.Threading.CancellationToken 'System.Threading.CancellationToken')[&gt;](https://docs.microsoft.com/en-us/dotnet/api/System.Nullable-1 'System.Nullable`1')  
(optional)<br/>  
Cancellation token for cancellation the operation.  
